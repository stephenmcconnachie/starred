...
- [Osmantic/ODS](https://github.com/Osmantic/ODS) - ODS V3: Turn your PC, Mac, or Linux box into an AI server. LLM inference, chat UI, voice, agents, workflows, RAG, and image generation.
