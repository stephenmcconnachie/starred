...
- [proxysoul/Empryo](https://github.com/proxysoul/Empryo) - Empryo is the graph-powered AI coding agent that edits symbols, not strings: AST surgery, full LSP, a live code genome. Get it at https://empryo.com
